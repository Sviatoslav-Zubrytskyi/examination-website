...
class Question {
    constructor(question0,img, audio, answer1, correct1 = false, answer2, correct2 = false, answer3, correct3 = false, answer4, correct4 = false) {
        this.questionList = {
            "question": question0,  
            "img": img,
            "audio": audio,
...
const questionSets = {
    "casualQuestions" : [
        new Question(
            "Are you Slava Marlow?", '../examination-website/src/tee_slava_merlow.jpg', "../examination-website/src/paranoya.mp3",
            "Yes", false,
            "No", false,
            "Right answer", true,
            "????", false
        ...
        new Question(
            "Whose flag is this??", '../examination-website/src/ukranian_flag.jpg', "",
            "Ukraine", true,
